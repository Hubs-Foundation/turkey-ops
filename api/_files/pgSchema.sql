...
CREATE TABLE ret0.hubs (
    ...
    scene_id bigint,
    entry_code integer,
    entry_code_expires_at timestamp(0) without time zone,
    ...
    member_permissions integer DEFAULT 63,
    allow_promotion boolean DEFAULT false NOT NULL,
...
CREATE TABLE ret0.room_objects (
    ...
    updated_at timestamp(0) without time zone NOT NULL,
    account_id bigint,
    CONSTRAINT room_object_is_legacy_or_has_account CHECK (((inserted_at < '2021-07-20 13:55:37.81049'::timestamp without time zone) OR (account_id IS NOT NULL)))
);
...
--
-- Name: hubs_entry_code_index; Type: INDEX; Schema: ret0; Owner: postgres
--

CREATE UNIQUE INDEX hubs_entry_code_index ON ret0.hubs USING btree (entry_code);
...
ALTER TABLE ONLY ret0.account_favorites
    ADD CONSTRAINT account_favorites_account_id_fkey FOREIGN KEY (account_id) REFERENCES ret0.accounts(account_id);
...
ALTER TABLE ONLY ret0.account_favorites
    ADD CONSTRAINT account_favorites_hub_id_fkey FOREIGN KEY (hub_id) REFERENCES ret0.hubs(hub_id);
...
ALTER TABLE ONLY ret0.api_credentials
    ADD CONSTRAINT api_credentials_account_id_fkey FOREIGN KEY (account_id) REFERENCES ret0.accounts(account_id);
...
ALTER TABLE ONLY ret0.hub_role_memberships
    ADD CONSTRAINT hub_role_memberships_account_id_fkey FOREIGN KEY (account_id) REFERENCES ret0.accounts(account_id);
...
ALTER TABLE ONLY ret0.hub_role_memberships
    ADD CONSTRAINT hub_role_memberships_hub_id_fkey FOREIGN KEY (hub_id) REFERENCES ret0.hubs(hub_id);
...
ALTER TABLE ONLY ret0.hubs
    ADD CONSTRAINT hubs_created_by_account_id_fkey FOREIGN KEY (created_by_account_id) REFERENCES ret0.accounts(account_id);
...
ALTER TABLE ONLY ret0.hubs
    ADD CONSTRAINT hubs_scene_id_fkey FOREIGN KEY (scene_id) REFERENCES ret0.scenes(scene_id);
...
ALTER TABLE ONLY ret0.room_objects
    ADD CONSTRAINT room_objects_account_id_fkey FOREIGN KEY (account_id) REFERENCES ret0.accounts(account_id);
...
ALTER TABLE ONLY ret0.room_objects
    ADD CONSTRAINT room_objects_hub_id_fkey FOREIGN KEY (hub_id) REFERENCES ret0.hubs(hub_id);
...
ALTER TABLE ONLY ret0.scenes
    ADD CONSTRAINT scenes_parent_scene_id_fkey FOREIGN KEY (parent_scene_id) REFERENCES ret0.scenes(scene_id);
...
GRANT SELECT,INSERT,UPDATE ON TABLE ret0_admin.projects TO ret_admin;
